...
public class FallenRiftHubDimension extends FallenRiftModElements.ModElement {
	public FallenRiftHubDimension(FallenRiftModElements instance) {
		super(instance, 15);
	}
	...
	public void clientLoad(FMLClientSetupEvent event) {
		...
		DeferredWorkQueue.runLater(() -> {
			try {
				...
				effectsRegistry.put(new ResourceLocation("fallen_rift:fallen_rift_hub"), customEffect);
			} catch (Exception e) {
				e.printStackTrace();
			}
		});
