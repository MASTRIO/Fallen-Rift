...
package net.mcreator.fallenrift.world.dimension;
...
public class FallenRiftDimension extends FallenRiftModElements.ModElement {
	public FallenRiftDimension(FallenRiftModElements instance) {
		super(instance, 13);
	}
	...
	public void clientLoad(FMLClientSetupEvent event) {
		DimensionRenderInfo customEffect = new DimensionRenderInfo(Float.NaN, true, DimensionRenderInfo.FogType.NONE, false, false) {
			...
			public Vector3d func_230494_a_(Vector3d color, float sunHeight) {
				return new Vector3d(0.576470588235, 0.576470588235, 0.576470588235);
			}
		...
		DeferredWorkQueue.runLater(() -> {
			try {
				...
				effectsRegistry.put(new ResourceLocation("fallen_rift:fallen_rift"), customEffect);
			} catch (Exception e) {
				e.printStackTrace();
			}
		});
