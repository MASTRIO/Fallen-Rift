...
package net.mcreator.fallenrift.particle;
...
public class CrimsonShrubBlingParticle extends FallenRiftModElements.ModElement {
	public static final BasicParticleType particle = new BasicParticleType(false);
	public CrimsonShrubBlingParticle(FallenRiftModElements instance) {
		super(instance, 24);
	...
	public void registerParticleType(RegistryEvent.Register<ParticleType<?>> event) {
		event.getRegistry().register(particle.setRegistryName("crimson_shrub_bling"));
	}
	...
	private static class CustomParticle extends SpriteTexturedParticle {
		...
		protected CustomParticle(ClientWorld world, double x, double y, double z, double vx, double vy, double vz, IAnimatedSprite spriteSet) {
			...
			this.maxAge = (int) Math.max(1, 7 + (this.rand.nextInt(10) - 5));
			this.particleGravity = (float) -0.9;
